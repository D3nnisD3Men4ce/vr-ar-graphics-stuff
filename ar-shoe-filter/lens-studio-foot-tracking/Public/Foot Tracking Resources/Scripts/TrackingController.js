...
function initCamera() {
    global.TrackingCamera = function(camera) {
        this.camera = camera;
        this.cameraSize = null;
        this.intrinsics = null;
    };
    
    global.TrackingCamera.prototype = {
        update: function() {
    ...
    trackingCamera = new global.TrackingCamera(script.camera);
    trackingCamera.update();

    modelToCamTexMult = new Float32Array(2);
    modelToCamTexMult[TYPE.LEFT] = trackingCamera.cameraSize.x / modelConfig.textureSize.x;
    modelToCamTexMult[TYPE.RIGHT] = trackingCamera.cameraSize.y / modelConfig.textureSize.y;
...
function onCameraChanged() {
    ...
    if (opticalFlow != null && opticalFlow.textureSize != null) {
        ...
        opticalFlow.optFlowToCamTexMult[TYPE.LEFT] = trackingCamera.cameraSize.x / opticalFlow.textureSize.x;
        opticalFlow.optFlowToCamTexMult[TYPE.RIGHT] = trackingCamera.cameraSize.y / opticalFlow.textureSize.y;
    }
}
